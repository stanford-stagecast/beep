...
# Copyrigh 2020 The TensorFlow Authors. All Rights Reserved.
#
...
def aot_compile_cpu_meta_graph_def(checkpoint_path,
  ...
  temp_dir = "/tmp/sadjad"#test.get_temp_dir()
  ...
  shutil.copyfile(frozen_graph_def_location, 'frozen_graph.pb')
  shutil.copyfile(config_pbtxt_location, 'config.pbtxt')
...
if __name__ == "__main__":
  ...
  aot_compile_cpu_meta_graph_def(checkpoint_path, saved_model_utils.get_meta_graph_def(
      model_dir, 'serve'), '', signature_constants.DEFAULT_SERVING_SIGNATURE_DEF_KEY, '', '', '')
